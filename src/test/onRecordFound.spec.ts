...
const curriedOnRecordFound = partial(
  onRecordFound,
  EXTERNAL_URL,
  ckanServerApiKeyMap
);
...
const tokenCkanResponse: any = {
  ...
  notes:
    "A good dataset description clearly and succinctly explains the contents, purpose and value of the dataset. This is how users primarily identify and select your dataset from others. Here you can also include information that you have not already covered in the metadata.",
  owner_org: null,
  extras: [],
  title: "Mars Bar",
...
const testRecord = {
  aspects: {
    ...
    "temporal-coverage": {
      intervals: ["2020-01-10T01:21:23.724Z", "2020-01-20T01:21:23.724Z"],
    },
    "dataset-publisher": {
    ...
    provenance: {
      mechanism:
        "Briefly describe the methodology of producing this dataset or any other information that might assist consumers of the dataset.\n",
...
describe("Magda ckan-exporter minion", function (this: Mocha.Suite) {
  this.timeout(10000);
  ...
  beforeEach(() => {
    ...
    ckanScope = nock(CKAN_SERVER_URL, {
      reqheaders: { authorization: CKAN_API_KEY },
    }).persist();
  });
  ...
  describe("Creating a CKAN package", () => {
    it("Successful creation", async () => {
      ...
      registryScope
        .put(
          "/records/ckan-export-create-pkg-test-success/aspects/ckan-export?merge=true"
        )
        .reply(200);
      ckanScope
    ...
    it("Should not create", async () => {
      ...
      newTestRecord.aspects["ckan-export"][CKAN_SERVER_URL] =
        newCkanExportAspect;
      ...
      registryScope
        .put(
          "/records/ckan-export-create-pkg-test-failure/aspects/ckan-export?merge=true"
        )
        .optionally()
        .reply(500, () => {
          expect.fail();
  ...
  describe("Updating a CKAN package", () => {
    it("Successful update", async () => {
      ...
      registryScope
        .put(
          "/records/ckan-export-update-pkg-test-success/aspects/ckan-export?merge=true"
        )
        .reply(200);
      ckanScope
        .post("/api/3/action/package_show")
    ...
    it("Should not update", async () => {
      ...
      registryScope
        .put(
          "/records/ckan-export-update-pkg-test-failure/aspects/ckan-export?merge=true"
        )
        .optionally()
        .reply(500, () => {
          expect.fail();
  ...
  describe("Deleting a CKAN package", () => {
    it("Successful deletion", async () => {
      ...
      registryScope
        .put(
          "/records/ckan-export-delete-pkg-test-success/aspects/ckan-export?merge=true"
        )
        .reply(200);
      ckanScope
        .post("/api/3/action/package_show")
    ...
    it("Should not delete", async () => {
      ...
      registryScope
        .put(
          "/records/ckan-export-delete-pkg-test-failure/aspects/ckan-export?merge=true"
        )
        .optionally()
        .reply(500, () => {
          expect.fail();
